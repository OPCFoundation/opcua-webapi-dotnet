...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class CallResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CallResponse(ResponseHeader responseHeader = default, List<CallMethodResult> results = default, List<DiagnosticInfo> diagnosticInfos = default)
        {
