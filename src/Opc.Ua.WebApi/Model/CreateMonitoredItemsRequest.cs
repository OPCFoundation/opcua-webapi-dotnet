...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class CreateMonitoredItemsRequest : IValidatableObject
    {
        ...
        public CreateMonitoredItemsRequest(RequestHeader requestHeader = default, long subscriptionId = 0, int timestampsToReturn = default, List<MonitoredItemCreateRequest> itemsToCreate = default)
        {
