...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class DeleteMonitoredItemsResponse : IValidatableObject
    {
        ...
        public DeleteMonitoredItemsResponse(ResponseHeader responseHeader = default(ResponseHeader), List<StatusCode> results = default(List<StatusCode>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
