...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class HistoryUpdateResponse : IValidatableObject
    {
        /// <summary>
        ...
        public HistoryUpdateResponse(ResponseHeader responseHeader = default, List<HistoryUpdateResult> results = default, List<DiagnosticInfo> diagnosticInfos = default)
        {
