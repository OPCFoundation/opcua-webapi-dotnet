...
namespace Opc.Ua.WebApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonActionResponderMessage" /> class.
        /// </summary>
        ...
        public JsonActionResponderMessage(string messageId = default(string), string messageType = default(string), string publisherId = default(string), DateTime timestamp = default(DateTime), PubSubConnectionDataType connection = default(PubSubConnectionDataType))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JsonActionResponderMessage {\n");
