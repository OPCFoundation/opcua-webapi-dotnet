...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class JsonActionResponderMessage : IValidatableObject
    {
        ...
        public JsonActionResponderMessage(string messageId = default, string messageType = default, string publisherId = default, DateTime timestamp = default, PubSubConnectionDataType connection = default)
        {
