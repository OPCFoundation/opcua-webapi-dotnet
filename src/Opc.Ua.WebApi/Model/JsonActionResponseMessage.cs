...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class JsonActionResponseMessage : IValidatableObject
    {
        ...
        public JsonActionResponseMessage(int dataSetWriterId = 0, int actionTargetId = 0, string dataSetWriterName = default, string writerGroupName = default, ConfigurationVersionDataType metaDataVersion = default, long minorVersion = 0, DateTime timestamp = default, StatusCode status = default, string messageType = default, int requestId = 0, int actionState = default, Object payload = default)
        {
