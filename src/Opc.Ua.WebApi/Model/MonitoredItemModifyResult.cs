...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class MonitoredItemModifyResult : IValidatableObject
    {
        ...
        public MonitoredItemModifyResult(StatusCode statusCode = default, double revisedSamplingInterval = 0D, long revisedQueueSize = 0, ExtensionObject filterResult = default)
        {
