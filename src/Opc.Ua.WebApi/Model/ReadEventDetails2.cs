...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class ReadEventDetails2 : IValidatableObject
    {
        ...
        public ReadEventDetails2(bool readModified = false, long numValuesPerNode = 0, DateTime startTime = default, DateTime endTime = default, EventFilter filter = default)
        {
