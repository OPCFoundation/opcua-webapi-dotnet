...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class SetPublishingModeResponse : IValidatableObject
    {
        /// <summary>
        ...
        public SetPublishingModeResponse(ResponseHeader responseHeader = default(ResponseHeader), List<StatusCode> results = default(List<StatusCode>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
