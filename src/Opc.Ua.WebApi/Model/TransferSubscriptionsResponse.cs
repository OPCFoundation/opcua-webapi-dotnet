...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class TransferSubscriptionsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public TransferSubscriptionsResponse(ResponseHeader responseHeader = default, List<TransferResult> results = default, List<DiagnosticInfo> diagnosticInfos = default)
        {
