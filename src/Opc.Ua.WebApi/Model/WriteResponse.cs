...
namespace Opc.Ua.WebApi.Model
{
    ...
    public partial class WriteResponse : IValidatableObject
    {
        /// <summary>
        ...
        public WriteResponse(ResponseHeader responseHeader = default(ResponseHeader), List<StatusCode> results = default(List<StatusCode>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
